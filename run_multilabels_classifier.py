...
def create_model(bert_config, is_training, input_ids, input_mask, segment_ids,
    ...
    W_1 = tf.get_variable('dense_W1', [hidden_size, int(hidden_size / 2)], initializer=tf.truncated_normal_initializer(stddev=0.02))
    b_1 = tf.get_variable('dense_b1', [int(hidden_size / 2)], initializer=tf.zeros_initializer())
    W_2 = tf.get_variable('dense_W2', [int(hidden_size / 2), num_labels], initializer=tf.truncated_normal_initializer(stddev=0.02))
    ...
    with tf.variable_scope("loss"):
        ...
        logits_1 = tf.nn.relu(tf.nn.xw_plus_b(output_layer, W_1, b_1))
...
def main(_):
    ...
    if FLAGS.do_eval:
        ...
        with tf.gfile.GFile(output_eval_file, "w") as writer:
            ...
            writer.write("threthold: {}".format(threthold))
